...
<body>
	<table>
		...
		<tr id="tr1">
			<td>
				<div id="divep">
				<form action="validaModificacion.php?opModuloSel=<?php echo $opModuloSel ?>" method="POST" accept-charset="utf-8">
					<br><br>
					...
					<br><br>
					<h4>Seleccione pregunta a modificar:</h4>
					<br>
					<br>
					<?php
